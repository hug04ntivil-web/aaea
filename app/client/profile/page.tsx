...
export default function ClientProfilePage() {
  ...
  if (loading) return (
    <AppShell role="client" userName="" pageTitle="Mi perfil">
  ...
  return (
    <AppShell role="client" userName={fullName} pageTitle="Mi perfil">
      <div className="max-w-lg mx-auto space-y-5">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
          <h3 className="font-semibold text-gray-800">Mis datos</h3>
          <div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <button onClick={changePassword} disabled={changingPassword}
            ...
            <Lock size={15} /> {changingPassword ? "Cambiando..." : "Cambiar contraseña"}
          </button>
        </div>
      </div>
    </AppShell>
